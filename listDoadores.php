...
$sql =$link->query("SELECT * FROM tb_doador");
...
echo '<tr>
	  ...
	  <td><button type="button" class="btn btn-danger role="button" data-toggle="modal" data-target="#'.$id.'"">
		  ...
		  <a href="editarDoador?idDoador='.$id.'"><button type="button" class="btn btn-danger">
		  <span class="glyphicon glyphicon-pencil" aria-hidden="true" title="Editar"></span>
		  </button></a>
		  <a href="deleteDoador?idDoador='.$id.'" onclick="'.$confirmar.'"><button type="button" class="btn btn-danger">
