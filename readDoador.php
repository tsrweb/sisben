      ...
      <h2>SisBen</h2>
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            	...
            	<form>
				    ...
				    <div class="col-md-4">
				  		<div class="form-group">
						    ...
						    <input type="text" class="form-control" value="<?=$cpfcnpj?>" id="disabledInput" disabled>
				  				</div>
									</div>
				    <div class="col-md-3">
				  		<div class="form-group">
            ...
            <div class="row">
              <div class="col-md-4">
                <a href="cadastrarDoador" title="Novo Doador"><button type="button" class="btn btn-danger">Novo</button></a>
                <a href="editarDoador?idDoador=<?=$idDoador?>" title="Editar"><button type="button" class="btn btn-danger">Editar</button></a>
              	<a href="deleteDoador?idDoador=<?=$idDoador?>" title="Excluir Doador" onclick="return confirm('Deseja realmente excluir este cadastro?');"><button type="button" class="btn btn-danger">Excluir</button></a>
              	<a href="sisBenPrefeitura" title="Voltar ao Início"><button type="button" class="btn btn-danger">Início</button></a>
              </div>
            </div>
				</form>
               </div>
