      ...
      <h2>SisBen</h2>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Assistentes Sociais Cadastrados</h3>
              </div>
...
$sql =$link->query("SELECT * FROM tb_assistenteSocial WHERE id_prefeitura = '$idPrefeitura'");
...
echo '<tr>
	  ...
	  <td><button type="button" class="btn btn-danger role="button" data-toggle="modal" data-target="#'.$id.'"">
		  ...
		  <a href="editarAssistente?idAssistente='.$id.'"><button type="button" class="btn btn-danger">
		  <span class="glyphicon glyphicon-pencil" aria-hidden="true" title="Editar"></span>
		  </button></a>
		  <a href="deleteAssistente?idAssistente='.$id.'" onclick="'.$confirmar.'"><button type="button" class="btn btn-danger">
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <strong>CNPJ:</strong> '.$cpf.' <strong>Telefone:</strong> '.$fone.'<br>
