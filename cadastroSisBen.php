              ...
              <div class="row">
                <div class="col-md-6 col-md-offset-3">
                  <div class="alert alert-danger text-center" role="alert">
                    <strong>Atenção!</strong> Informações sujeita a confirmações por nossos assistentes sociais através de solicitações de documentos e comprovantes.</div>
                   </div>
                 </div>
            	<form method="post" action="newCadastro">
            		<div class="row">
            			<div class="col-md-4">
				       ...
				       <div class="col-md-3">
    				  		<div class="form-group">
    						    ...
    						    <input type="text" class="form-control" id="cpf" name="cpf" autocomplete="off" placeholder="000.000.000-00" required>
				  				</div>
								</div>
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="rg" name="rg" autocomplete="off" required>
				    ...
				    <div class="col-md-3">
				  		<div class="form-group">
						    ...
						    <input type="text" class="form-control" id="pis" name="pis" autocomplete="off">
				  				</div>
								</div>
				</div><!-- /row -->
          <div class="row">
              ...
              <div class="form-group">
                <label for="renda">Renda Familiar:</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" aria-describedby="basic-addon2" name="renda" pattern="[0-9]+$"><div class="input-group-addon">.00</div>
                    </div>
                  </div>
                </div>
            </div><!-- /row -->
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control text-uppercase" id="nDependente" name="nDependente" maxlength="2">
                </div>
              </div>
          </div><!-- /row -->
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="form-group form-inline">
                  ...
                  <input type="text" class="form-control text-uppercase" id="nDeficiente" name="nDeficiente" maxlength="2" style="width: 100px;">
                </div>
              </div>            
          </div><!-- /row -->
			 <div class="row">
        	...
        	<div class="col-md-3">
					    ...
					    <input type="password" class="form-control" id="confirSenha" name="confirSenha" required>
				 				</div>
        	   	</div>
            </div><!-- /row -->
          <div class="row">
