      ...
      <h2>SisBen</h2>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Editar Prefeitura</h3>
              </div>
          <div class="panel-body">
            <div class="col-md-12">
            	<form method="post" action="updatePrefeitura?idPrefeitura=<?=$idPrefeitura?>">
                <div class="row">
                  <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="cnpj" name="cnpj" autocomplete="off" value="<?=$cnpj?>" id="disabledInput" disabled>
                  </div>
                  </div>
            <div class="col-md-3">
              <div class="form-group">
